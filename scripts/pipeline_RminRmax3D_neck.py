...
from helpers import trim_contours_to_match_zs_edge, get_elongation3D, get_info_replanned
...
def pipeline_elongation_neck(param_name='elongation3Dneck',path_contours,CSV_patients_ids,path_CBCTs):
    t_init = process_time()
    ...
    for str_pat_id in ids_patients:
        ...
        if str_pat_id in existing_patients:
            ...
            mandible_contour = rtdsm.get_pointcloud(mandible, path_rs_b0, False)[0]
            ...
            for key_body_n in range(0,len(contours_neck)):
                ...
                Rmax,Rmin,El,Rmean = get_elongation3D(trim_neck,trim_neck0)
...
if __name__ == "__main__":
    ...
    pipeline_elongation_neck(path_contours,CSV_patients_ids,path_CBCTs)
