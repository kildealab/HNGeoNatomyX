...
from helpers import trim_contours_to_match_zs_edge, get_info_replanned, get_max_between_contours_by2Dv2
...
def pipeline_params_neck2D_distances(param_name='distances2Dneck', path_contours,CSV_patients_ids,path_CBCTs):
    t_init = process_time()
    ...
    for str_pat_id in ids_patients:
        ...
        if str_pat_id in existing_patients:
            ...
            for key_body_n in range(0,len(contours_neck)):
                ...
                trim_neck,trim_neck0 = trim_contours_to_match_zs_edge(neck_contour,contours00,z_min_necks,z_max_necks)
            
                params = []
        
                gc.collect()
     
                dmax,dmean,dmedian = get_max_between_contours_by2Dv2(trim_neck,trim_neck0)
...
if __name__ == "__main__":
    ...
    pipeline_params_neck2D_distances(path_contours,CSV_patients_ids,path_CBCTs)
