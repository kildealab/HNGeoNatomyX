        ...
        if str_pat_id in existing_patients:
            ...
            for key_body_n in range(0,len(key_bodies_to_save)):
                ...
                if key_bodies_to_save[key_body_n]=='BODY':
                    ...
                    #h,k = get_center(contour_body_1,r)
                    ...
                    max_distance,avg_distance,std_distance = get_dist_mask_body(pv.PolyData(d11),pv.PolyData(trim_body2))
                    
                    print(max(trim_body2[:,2]),min(trim_body2[:,2]))
                    print(max(d11.points[:,2]),min(d11.points[:,2]))
