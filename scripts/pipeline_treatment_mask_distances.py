...
def pipeline_mask_distances(param_name='distancesMask',path_contours, CSV_patient_ids,path_CBCTs, path_treatment_masks):
    t_init = process_time()
            ...
            for key_body in range(0,len(key_bodies_to_save)):
                ...
                if len(contour_body) == 0:
                    ...
                    if key_bodies_to_save[key_body]=='BODY':
                        ...
                        max_distance,avg_distance,std_distance = get_dist_mask_body(pv.PolyData(mask_final),pv.PolyData(trim_body2))
                        ...
                        params.append(avg_distance)
                        params.append(std_distance)
