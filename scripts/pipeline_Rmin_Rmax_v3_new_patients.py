...
def pipeline_dist_body(param_name='vectors_body',path_k = '/mnt/iDriveShare/OdetteR/Registration_and_contours/Contours/'):
    ...
    for str_pat_id in ids_news:
        ...
        if str_pat_id in existing_patients:
            ...
            if len(body_list)==0:
                ...
                mandiblee = rtdsm.get_pointcloud(key_mandible,path_rs,False)[0]
 ...
 #                   h,k = get_center(body1,body2,r)
         ...
         #           dfx = 1
                ...
                z_m = get_min_mandible_slice(s_body1.points,mandiblee)
                contour0 = get_surface_marching_cubes(contour00[0],pixel_spacing3)
                
                z_m2 = get_min_mandible_slice(contour0.points,mandiblee)
