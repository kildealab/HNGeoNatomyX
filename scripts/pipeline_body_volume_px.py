...
def get_equal_bodyv2(body2,body1,z_max,z_min,h,k,r):
    ...
    #s#_body2 = pv.PolyData(s_body22).connectivity(largest=True)
...
def pipeline_volumes(param_name='volumes',path_k = '/mnt/iDriveShare/OdetteR/Registration_and_contours/Contours/'):
    ...
    for str_pat_id in ids_news:
        ...
        if str_pat_id in existing_patients:
            ...
            # get contours of PTV
            ptv = get_keys_v2('ptv',str_pat_id, path_rs_b0)
            contours_PTV = rtdsm.get_pointcloud(ptv[0], path_rs_b0, False)[0]
