...
| Ratio between minimum and maximum 3D radius | $$\varphi^{3D}_{R}$$ | Ratio between the $R^3D_{max}$ and $R^3D_{min}$. This metric characterizes the symmetry of the mesh|
