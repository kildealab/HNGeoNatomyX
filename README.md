...
| Ratio between minimum and maximum 3D radius | $$\varphi^{3D}_{R}$$ | Ratio between the $R^{3D}_{max}$. 3D radius and min. 3D radius. This metric characterizes the symmetry of the mesh|
